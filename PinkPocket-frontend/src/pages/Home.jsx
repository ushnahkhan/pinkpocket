    ...
    <div className="home">
      <section className="ad-card">
        <div className="ad-card-left">
          <div className="ad-card-placeholder">
            <img src={hearticon} className="ad-card-icon" alt="heart" />
          </div>
          <p>Product Image</p>
        </div>
        <div className="ad-card-right">
          ...
          <div className="ad-card-buttons">
            {user ? (
              <button onClick={() => navigate("/products")} className="btn-pmry">
      ...
      <section className="categories">
        ...
        <div className="category-grid">
          {["All", "Stationery", "Accessories"].map((item, i) => (
            <div key={i} className="category-card" onClick={() => navigate("/products")}>
              <img src={images[i]} className="cat-icon" alt={item} />
              <h3>{item}</h3>
              <p>{10 + i} products</p>
            </div>
          ))}
      ...
      <section className="whyus">
        <h2 className="section-header">Why Shop With Us?</h2>
        <div className="whyus-grid">
          <div className="whyus-card">
            <img src={sparkle} className="whyus-icon" alt="sparkle" />
            <h4>Curated Collection</h4>
            <p>Pinterest inspired aesthetic designs handpicked for you</p>
          </div>
          <div className="whyus-card">
            <img src={hearticon} className="whyus-icon" alt="heart" />
            <h4>Budget Friendly</h4>
            <p>Quality products at affordable prices</p>
          </div>
          <div className="whyus-card">
            <img src={star} className="whyus-icon" alt="star" />
      ...
      <section className="features">
        <div className="features-tab">
          <img src={truck} className="features-icon" alt="truck" />
          <h3>Free Shipping</h3>
          <p>On orders over PKR 3000</p>
        </div>
        <div>
          <img src={boxicon} className="features-icon" alt="box" />
          <h3>Easy Returns</h3>
          <p>30-day return policy</p>
        </div>
        <div>
          <img src={hearticon} className="features-icon" alt="heart" />
          <h3>Aesthetic Packaging</h3>
          <p>Carefully packaged with love</p>
        </div>
        <div>
          <img src={shield} className="features-icon" alt="shield" />
      ...
      <section className="cta">
        ...
        <div className="cta-buttons">
          ...
          >
            <img src={hearticon} className="joinus-icons" alt="instagram" />
